...
import org.fufeng.tdd.api.model.StudentRepositoryImpl;
...
public class StudentApplication extends ResourceConfig {
    ...
    public StudentApplication(StudentRepository studentRepository) {
        // scan packages
        this.register(new StudentResources(studentRepository));
    ...
    public static void main(String[] args) throws Exception {
        ...
        JettyHttpContainerFactory
                .createServer(UriBuilder.fromUri("http://localhost/").port(8080).build(), new StudentApplication(new StudentRepositoryImpl()))
                .start();
    }
}
